"""
Author: Prathamesh Sarang (@pratos)
Task: Benchmarking of Optimizers

Parallelization of model build so that we can view how the optimizers compare
the optimizers against each other.
"""
import os
import time
import datetime
...
def data_prep():
	"""Downloading the MNIST Dataset and pre-processing it
	...
	output
	------
	Returns mnist object that includes (train, test, validation images and labels)
	"""
